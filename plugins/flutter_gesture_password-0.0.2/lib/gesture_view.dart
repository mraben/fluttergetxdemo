...
class GestureView extends StatefulWidget {
  ...
  final bool Function(List<int>)? clearOnComplete;
  GestureView({required this.width, required this.height, required this.listener,this.clearOnComplete});
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        GesturePathView(widget.width, widget.height, _points, widget.listener,clearOnComplete: widget.clearOnComplete,)
      ],
    );
  }
}
